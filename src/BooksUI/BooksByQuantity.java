 ...
 * @author salom
 */
public class BooksByQuantity extends javax.swing.JFrame {

    Connector myConnector;
    ResultSet rs,rs2;
    /**
     * Creates new form BooksByQuantity
     */
    public BooksByQuantity() throws SQLException {
        initComponents();
        setTitle("BOOKS ORDERED BY QUANTITY");
        initializeConnector();
        getBookDetails();
        displayBookDetails();
    ...
    public void getBookDetails() throws SQLException{
        myConnector.prepStatement("SELECT * FROM books ORDER BY Quantity");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            Logger.getLogger(BooksByQuantity.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BooksByQuantity.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new BooksByQuantity().setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(BooksByQuantity.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
