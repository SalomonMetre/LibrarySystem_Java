 ...
 * @author salom
 */
public class BooksByAuthor extends javax.swing.JFrame {

    Connector myConnector;
    ResultSet rs,rs2;
    /**
     * Creates new form BooksByAuthor
     */
    public BooksByAuthor() throws SQLException {
        initComponents();
        setTitle("BOOKS ORDERED BY AUTHOR");
        initializeConnector();
        getBookDetails();
        displayBookDetails();
    ...
    public void getBookDetails() throws SQLException{
        myConnector.prepStatement("SELECT * FROM books ORDER BY AuthorID");
    ...
    public void borrowBook() throws SQLException{
        ...
        myConnector.pst.setInt(1, quantity>0?quantity-1:quantity);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            Logger.getLogger(BooksByAuthor.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BooksByAuthor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new BooksByAuthor().setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(BooksByAuthor.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
