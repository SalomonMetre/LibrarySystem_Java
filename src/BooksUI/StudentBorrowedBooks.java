 ...
 * @author salom
 */
public class StudentBorrowedBooks extends javax.swing.JFrame {
     ...
     */
    public StudentBorrowedBooks() throws SQLException {
        initComponents();
        setTitle("BORROWED BOOKS : STUDENT VIEW");
        initializeConnector();
        getBorrowDetails();
    ...
    public void getBorrowDetails() throws SQLException{
        myConnector.prepStatement("SELECT * FROM borrows WHERE AdmissionNo=?");
    ...
    public void updateBorrowDetails() throws SQLException{
        ...
        myConnector.prepStatement("UPDATE borrows SET Returned='Yes' WHERE BookID=?");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StudentBorrowedBooks.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new StudentBorrowedBooks().setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(StudentBorrowedBooks.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
